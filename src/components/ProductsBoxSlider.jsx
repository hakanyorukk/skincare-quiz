...
function ProductsBoxSlider() {
  ...
  // Handle screen resizing to check if it's small
  useEffect(() => {
    const checkScreenSize = () => {
      setIsSmallScreen(window.innerWidth < 768); // Example: small screen if less than 768px
    };
  ...
  // Determine number of items per group based on screen size
